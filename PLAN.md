...
- [ ] **Ressort Sport/Kultur — Scoring öffnen (E50):** nach Beobachtung des nächsten Runs `score.ts`-Malus (`LOW_VALUE_KEYWORDS` −0,3, `EVENT_PR_KEYWORDS` −0,15) für *große* Sport/Kultur-Events kalibriert lockern, ohne Spielbericht-/Boulevard-Flut — sonst erreichen Sport/Kultur-Cluster die Triage-Schwelle nie
