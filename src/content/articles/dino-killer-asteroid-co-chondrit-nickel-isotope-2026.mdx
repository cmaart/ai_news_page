---
title: Asteroid, der die Dinosaurier auslöschte, war ein extrem seltener Meteoritentyp
description: "Eine neue Nickel-Isotopen-Analyse zeigt: Der rund zehn Kilometer große Asteroid, der vor 66 Millionen Jahren im Golf von Mexiko einschlug und die Dinosaurier auslöschte, gehörte zur seltenen Gruppe der CO-Chondriten aus dem äußeren Asteroidengürtel."
publishedAt: 2026-07-22T04:07:26.604Z
topic: wissenschaft
country: at
status: published
...
confidence: high
confidenceNote: Der Wiener Impaktforscher Christian Köberl erklärt die Ergebnisse als Studienautor selbst gegenüber Medien, und drei unabhängige Redaktionen (ORF, futurezone, heise) berichten übereinstimmend über dieselbe Publikation.
primarySourceStrength: weak
sourceStrengthNote: Die zugrunde liegende Studie in Science Advances wurde über die Websuche als existierend und mit passendem Titel identifiziert, aber nicht im Volltext gelesen — daher stützt sich der Artikel primär auf die Angaben der Medienberichte, darunter ein direktes Zitat des Studienautors.
framingRisk: low
framingRiskNote: Es handelt sich um eine naturwissenschaftliche Erkenntnis ohne gegenläufige Interessen oder Konfliktparteien; mehrere Fachleute werden mit übereinstimmenden Einschätzungen zitiert.
newsworthiness: 3
summary:
  - text: Ein rund zehn Kilometer großer Asteroid, der vor 66 Millionen Jahren im Golf von Mexiko einschlug und die Dinosaurier auslöschte, war laut einer neuen Studie ein extrem seltener „CO-Chondrit“.
    kind: fact
  - text: Ein internationales Team um den Wiener Impaktforscher Christian Köberl wertete dafür Nickel-Isotope in weltweit verteiltem Auswurfmaterial aus der Einschlagszeit aus und veröffentlichte die Ergebnisse im Fachjournal „Science Advances“.
    kind: fact
  - text: CO-Chondrite machen nur rund zwei bis drei Prozent aller bekannten Meteoriten aus und stammen mutmaßlich aus dem äußeren, jupiternahen Bereich des Asteroidengürtels.
    kind: fact
  - text: Die Gesteinsart ist im Vergleich zu anderen kohligen Chondriten trocken und arm an flüchtigen Stoffen wie Schwefel und Wasser.
    kind: fact
  - text: Details zum vollständigen Autorenteam, zur genauen Probenherkunft und zur Frage, wie stark aufgewirbelter Staub im Vergleich zu freigesetzten Gasen zum weltweiten Klimaeffekt beitrug, lassen sich anhand der vorliegenden Berichte nicht abschließend klären.
    kind: open
openQuestions:
  - Welche Auswurflager-Standorte wurden konkret für die Nickel-Isotopen-Messungen untersucht, und wie viele Proben flossen ein?
  - Wer genau gehörte neben Christian Köberl und Philippe Claeys zum vollständigen Autorenteam der Studie?
  - Wie stark trug aufgewirbelter Staub im Vergleich zu freigesetzten Gasen (Schwefel, Kohlendioxid) zum globalen „Impaktwinter“ bei?
  - Wann genau erschien die Studie in „Science Advances“, und was besagt der Volltext des Abstracts über die Methodik im Detail?
sources:
  - id: src1
    name: futurezone
    type: media
    url: https://futurezone.at/science/dinosaurier-neue-erkenntnisse-killer-meteorit-impaktwinter/403177207
  - id: src2
    name: ORF Science
    type: media
    url: https://science.orf.at/stories/3236540
  - id: src3
    name: heise online
    type: media
    url: https://www.heise.de/news/Asteroideneinschlag-Dinosaurier-von-aeusserst-seltenem-Meteoritentyp-ausgeloescht-11370610.html
  - id: src4
    name: Science Advances (Studie)
    type: study
    url: https://www.science.org/doi/10.1126/sciadv.aef4858
claims:
  - id: claim1
    text: Ein rund zehn Kilometer großer Asteroid schlug vor 66 Millionen Jahren im Gebiet des heutigen Golf von Mexiko ein und löste über einen weltweiten Klimaeinbruch das Massensterben der Dinosaurier aus.
    status: supported
    note: Etabliertes Ergebnis der seit 1980 bestehenden Impakt-Theorie, von allen drei Medienquellen übereinstimmend dargestellt.
    sourceIds:
      - src1
      - src2
      - src3
  - id: claim2
    text: Ein internationales Forschungsteam mit Beteiligung von Christian Köberl (Universität Wien) hat anhand von Nickel-Isotopen-Analysen von Auswurfmaterial herausgefunden, dass der einschlagende Körper die Zusammensetzung eines CO-Chondriten hatte, und die Ergebnisse in „Science Advances“ veröffentlicht.
    status: supported
    note: Direktes Zitat und Erklärung des Studienautors Köberl in einem Fachmedium, zusätzlich durch das Auffinden der passenden Studie über die Websuche gestützt.
    sourceIds:
      - src2
      - src4
  - id: claim3
    text: CO-Chondrite sind eine seltene Untergruppe kohliger Chondrite, die nur rund zwei bis drei Prozent aller bekannten Meteoriten ausmachen und vermutlich aus dem äußeren, jupiternahen Bereich des Asteroidengürtels stammen.
    status: supported
    note: Von Köberl im ORF-Interview so erläutert.
    sourceIds:
      - src2
  - id: claim4
    text: CO-Chondrite sind im Vergleich zu anderen kohligen Chondriten relativ trocken und arm an flüchtigen Elementen wie Schwefel und Wasser.
    status: supported
    note: Direktes Zitat Köberls im ORF-Beitrag.
    sourceIds:
      - src2
  - id: claim5
    text: Bereits eine frühere Studie hatte vor zwei Jahren anhand von Ruthenium-Isotopen gezeigt, dass es sich beim Chicxulub-Impaktor allgemein um einen kohligen Chondriten handelte; die neue Nickel-Isotopen-Analyse grenzt dies nun auf den CO-Typ ein.
    status: supported
    note: Im ORF-Artikel als Vorgeschichte der aktuellen Studie dargestellt.
    sourceIds:
      - src2
corrections: []
---
