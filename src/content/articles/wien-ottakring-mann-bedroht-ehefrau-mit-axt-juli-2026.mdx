...
confidence: medium
confidenceNote: "Der Kernvorfall – eine Axt-Drohung gegen die Ehefrau in Wien-Ottakring am Freitag – wird von zwei redaktionell unabhängigen Medien (ORF und Kurier) berichtet, was ihn im Sinne einer Zwei-Quellen-Bestätigung vergleichsweise gesichert erscheinen lässt; weiterführende Details wie Festnahme oder rechtliche Konsequenzen sind dagegen nicht belegt. Ein neu aufgetauchter Cluster-Bericht über eine mit 4,2 Promille alkoholisierte Person, die ihre Ehefrau in Wien-Floridsdorf mit einem Küchenmesser bedroht haben soll, wurde geprüft: Tatzeit, Ort und Tatwaffe unterscheiden sich eindeutig vom hier beschriebenen Ottakring-Fall, weshalb es sich um einen eigenständigen, nicht verwandten Vorfall handelt und keine Inhalte übernommen wurden."
...
corrections:
  - date: 2026-07-19T12:07:28.466Z
    type: update
    text: Ein neu registrierter Bericht über einen mit 4,2 Promille alkoholisierten Mann, der seine Ehefrau in Wien-Floridsdorf mit einem Küchenmesser bedroht haben soll, betrifft einen eigenständigen, anderen Vorfall (andere Tatzeit, anderer Ort, andere Tatwaffe) und wurde daher nicht in diesen Artikel übernommen; ein entsprechender Klarstellungshinweis wurde ergänzt.
---
