---
title: „Körperwelten“-Erfinder Gunther von Hagens ist im Alter von 81 Jahren gestorben
description: Der deutsche Anatom und Erfinder der Plastinationstechnik ist tot, wie seine Familie und das Institut für Plastination in einer eigenen Presseaussendung bestätigten. Von Hagens wurde weltweit durch seine „Körperwelten“-Ausstellungen bekannt und litt laut übereinstimmenden Medienberichten seit Jahren an Parkinson.
...
confidence: high
confidenceNote: Der Kern der Meldung – der Tod im Alter von 81 Jahren – wird sowohl von einer eigenen Presseaussendung der Familie und des Instituts für Plastination als auch von mehreren unabhängigen Medien übereinstimmend berichtet, gilt damit als gesichert.
primarySourceStrength: medium
sourceStrengthNote: Die Presseaussendung von Familie und Institut für Plastination wurde per Recherche eingesehen und liefert Todesdatum sowie biografische Eckdaten aus erster Hand, der volle Wortlaut der Aussendung wurde aber nicht komplett abgerufen.
framingRisk: medium
framingRiskNote: Die Darstellung stützt sich vor allem auf die würdigende Perspektive von Familie und Institut sowie auf Agenturmaterial; die Kritik an der Menschenwürde-Frage wird von den Medien nur zusammenfassend wiedergegeben, ohne dass Kritiker selbst zu Wort kommen.
newsworthiness: 3
summary:
  - text: Gunther von Hagens, Erfinder der Plastinationstechnik und Schöpfer der „Körperwelten“-Ausstellungen, ist im Alter von 81 Jahren gestorben.
    kind: fact
  - text: Familie und Institut für Plastination bestätigten den Tod in einer gemeinsamen Presseaussendung, als Todestag wird der 24. Juli 2026 genannt.
    kind: fact
  - text: Von Hagens litt laut übereinstimmenden Medienberichten seit vielen Jahren an einer Parkinson-Erkrankung.
    kind: fact
  - text: Seine Ausstellungen brachten ihm weltweiten Zuspruch, aber auch anhaltende Kritik wegen mutmaßlicher Verletzung der Menschenwürde ein.
    kind: fact
  - text: Wie es mit dem Institut für Plastination und den „Körperwelten“-Ausstellungen künftig weitergeht, ist offen.
    kind: open
openQuestions:
  - Wie geht es mit dem Institut für Plastination und den „Körperwelten“-Ausstellungen unter künftiger Leitung weiter?
  - Wann und in welcher Form findet eine öffentliche Trauerfeier statt?
  - Welche genauen Umstände führten unmittelbar zum Tod, über den Zusammenhang mit der langjährigen Parkinson-Erkrankung hinaus?
sources:
  - id: src1
    name: ORF.at
    type: media
    url: https://orf.at/stories/3437408
  - id: src2
    name: Der Standard
    type: media
    url: https://www.derstandard.at/story/3000000333084/leichenpraeparator-gunther-von-hagens-gestorben
  - id: src3
    name: Die Presse
    type: media
    url: https://www.diepresse.com/39834680/koerperwelten-erfinder-gunther-von-hagens-ist-tot
  - id: src4
    name: Kurier
    type: media
    url: https://kurier.at/chronik/welt/koerperwelten-gunther-von-hagens-gestorben-tod-leichen/403178321
  - id: src5
    name: Kleine Zeitung
    type: media
    url: https://www.kleinezeitung.at/artikel/39837775/umstrittener-leichenpraeparator-gunther-von-hagens-gestorben
  - id: src6
    name: Institut für Plastination / Familie von Hagens (Presseaussendung via OTS)
    type: official
    url: https://www.ots.at/presseaussendung/OTS_20260727_OTS0073/dr-gunther-von-hagens-erfinder-der-plastination-schoepfer-der-koerperwelten-ist-verstorben
claims:
  - id: claim1
    text: Gunther von Hagens ist im Alter von 81 Jahren gestorben.
    status: supported
    note: Von Familie/Institut in eigener Presseaussendung sowie von mehreren unabhängigen Medien übereinstimmend berichtet.
    sourceIds:
      - src6
      - src1
      - src2
  - id: claim2
    text: Familie und Institut für Plastination gaben den Tod in einer gemeinsamen Presseaussendung bekannt, als Todestag wird der 24. Juli 2026 genannt.
    status: supported
    note: Eigene Verlautbarung der Institution über sich selbst betreffendes Ereignis.
    sourceIds:
      - src6
  - id: claim3
    text: Von Hagens litt viele Jahre an einer Parkinson-Erkrankung.
    status: partial
    note: Alle vorliegenden Medienberichte gehen erkennbar auf dieselbe dpa-Meldung zurück und zählen damit als eine Quelle, keine unabhängige Zweitbestätigung durch Familie/Institut vorliegend.
    sourceIds:
      - src1
      - src2
      - src4
  - id: claim4
    text: Er entwickelte die Plastinationstechnik in den 1970er-Jahren in Heidelberg und gründete 1993 das Institut für Plastination.
    status: supported
    note: Übereinstimmend durch Presseaussendung der Institution und Medienberichte belegt.
    sourceIds:
      - src6
      - src1
  - id: claim5
    text: Sein Sohn Rurik von Hagens ist Geschäftsführer der 2006 gegründeten Firma, in der die Plastinate hergestellt werden.
    status: partial
    note: Nur von einer einzelnen Medienquelle berichtet, keine Zweitbestätigung.
    sourceIds:
      - src1
  - id: claim6
    text: Kritiker warfen von Hagens vor, mit seinen Ausstellungen die Menschenwürde zu verletzen.
    status: supported
    note: Von mehreren, unterschiedlich formulierenden Redaktionen unabhängig aufgegriffen.
    sourceIds:
      - src2
      - src4
      - src5
