---
title: Selenskyj kündigt Schritte zur Beilegung des Geschichtsstreits mit Polen an
description: Der ukrainische Präsident Wolodymyr Selenskyj hat laut Medienberichten angekündigt, Untersuchungen zu Massakern der Ukrainischen Aufstandsarmee (UPA) an Polen im Zweiten Weltkrieg auszuweiten und Archive für Historiker zu öffnen. Details und eine unabhängige Einordnung stehen noch aus.
...
confidence: medium
confidenceNote: Zwei redaktionell unabhängige österreichische Medien (Die Presse, ORF) berichten übereinstimmend über die Ankündigung, was für die Grundtatsache spricht, doch ohne eingesehene Primärquelle (Rede, offizielle Aussendung) bleibt die Detailtiefe unklar.
primarySourceStrength: weak
sourceStrengthNote: Es liegt keine direkt eingesehene Primärquelle vor, nur Zusammenfassungen zweier Medienberichte aus dem RSS-Cluster.
framingRisk: medium
framingRiskNote: Die Ankündigung wird vor allem aus ukrainischer Perspektive (Selenskyj) sowie mit einer knappen Reaktion Tusks wiedergegeben; Stimmen polnischer Historiker oder weiterer Institutionen fehlen in den vorliegenden Quellen.
newsworthiness: 4
summary:
  - text: Laut übereinstimmenden Medienberichten kündigte Präsident Selenskyj an, Untersuchungen zu Massakern der Ukrainischen Aufstandsarmee (UPA) an Polen im Zweiten Weltkrieg auszuweiten.
    kind: fact
  - text: Berichten zufolge will Selenskyj Geheimdienstarchive zur UPA-Geschichte für Historikerinnen und Historiker öffnen.
    kind: fact
  - text: Polens Ministerpräsident Donald Tusk soll sich offen für einen freundschaftlichen Dialog über die strittigen historischen Themen gezeigt haben.
    kind: fact
  - text: Ein konkreter Zeitplan oder nähere Details zur angekündigten Archivöffnung sind aus den vorliegenden Quellen nicht ersichtlich.
    kind: open
  - text: Reaktionen unabhängiger polnischer Historikerinnen und Historiker oder weiterer Institutionen liegen bislang nicht vor.
    kind: open
openQuestions:
  - Wie bewerten ukrainische und polnische Historikerinnen und Historiker die angekündigte Ausweitung der Untersuchungen?
  - Gibt es bereits einen Zeitplan oder ein Verfahren für die geplante Archivöffnung?
  - Wie reagieren weitere polnische Institutionen jenseits von Ministerpräsident Tusk auf die Ankündigung?
  - In welchem Verhältnis steht die Ankündigung zur vorangegangenen Aberkennung einer Auszeichnung durch Polens Präsidenten Nawrocki?
sources:
  - id: src1
    name: Die Presse
    type: media
    url: https://www.diepresse.com/38253088/selenskyj-will-geschichtsstreit-mit-polen-beilegen
  - id: src2
    name: ORF
    type: media
    url: https://orf.at/stories/3436524
claims:
  - id: claim1
    text: Selenskyj kündigte eine Ausweitung der Untersuchungen zu Massakern der Ukrainischen Aufstandsarmee (UPA) an Polen an.
    status: partial
    note: Von zwei österreichischen Medien berichtet, jedoch ohne eingesehene Originalaussage oder offizielles Dokument, das den genauen Umfang der Untersuchung belegt.
    sourceIds:
      - src1
      - src2
  - id: claim2
    text: Selenskyj will Geheimdienstarchive zur UPA-Geschichte für Historikerinnen und Historiker öffnen.
    status: partial
    note: In den Kurzzusammenfassungen des Clusters genannt, aber ohne Details zu Verfahren, Zeitpunkt oder Umfang der Öffnung.
    sourceIds:
      - src1
      - src2
  - id: claim3
    text: Die UPA tötete zwischen 1943 und 1945 in Wolhynien bis zu 100.000 Polinnen und Polen.
    status: unclear
    note: Historische Opferzahlen zum Wolhynien-Massaker variieren je nach Quelle erheblich; ohne eingesehene historiografische Primärquelle wird die Zahl hier nicht als gesichert behandelt.
    sourceIds:
      - src1
  - id: claim4
    text: Polens Präsident Karol Nawrocki entzog Selenskyj im Mai 2026 die höchste staatliche Auszeichnung.
    status: unclear
    note: Dieser Vorgang wird als Hintergrundinformation im Cluster erwähnt, konnte aber anhand der vorliegenden Kurzzusammenfassungen nicht eigenständig verifiziert werden.
    sourceIds:
      - src1
  - id: claim5
    text: Ministerpräsident Donald Tusk signalisierte Bereitschaft zu einem freundschaftlichen Dialog über die strittigen Themen.
    status: partial
    note: Laut Medienberichten geäußert, eine wörtliche Zitatprüfung anhand einer Primärquelle liegt nicht vor.
    sourceIds:
      - src1
      - src2
corrections: []
