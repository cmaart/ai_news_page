---
title: "Studie: Typisch österreichische Wörter wie „Paradeiser“ und „Jänner“ sterben in Printmedien nicht aus"
description: Ein Forschungsteam von ÖAW und Universität Wien zeigt im Fachjournal „Languages“, dass Austriazismen wie „Paradeiser“, „Sackerl“ oder „Jänner“ in österreichischen Zeitungen über rund 23 Jahre stabil geblieben sind.
...
confidence: high
confidenceNote: Die Studie selbst ist über ihren Eintrag im Fachjournal „Languages“ auffindbar und wird von mehreren österreichischen Medien inhaltlich übereinstimmend wiedergegeben; der Kernbefund gilt damit als bestätigt.
primarySourceStrength: weak
sourceStrengthNote: Die Publikation wurde nur über ihren Eintrag im Fachjournal gefunden, nicht im Volltext gelesen — Autor:innen und Detailzahlen zur Methodik sind daher nur mit Vorbehalt übernommen.
framingRisk: low
framingRiskNote: Es handelt sich um eine deskriptive Sprachstudie ohne widerstreitende Interessen oder Konfliktparteien, zu der keine Gegenposition nötig ist.
newsworthiness: 3
summary:
  - text: Eine Studie von ÖAW und Universität Wien im Fachjournal „Languages“ zeigt, dass typisch österreichische Wörter in heimischen Printmedien über rund 23 Jahre stabil geblieben sind.
    kind: fact
  - text: Begriffe wie „Paradeiser“, „Sackerl“ und „Jänner“ sterben demnach entgegen verbreiteter Befürchtungen nicht aus.
    kind: fact
  - text: Laut Angaben zur Publikation wurden 76 Wortgruppen mit rund 200 Varianten untersucht.
    kind: fact
  - text: Details zu Methodik, genauem Untersuchungszeitraum und regionalen Unterschieden innerhalb Österreichs sind aus den vorliegenden Quellen nicht vollständig ersichtlich.
    kind: open
openQuestions:
  - Welche genaue Methodik (Auswahl der Printmedien, exakter Zeitraum, statistisches Verfahren) liegt der Studie zugrunde?
  - Wie unterscheidet sich die Stabilität der Austriazismen regional, etwa zwischen West- und Ostösterreich?
  - Gilt der Befund auch für gesprochene Sprache oder digitale Kommunikation, oder beschränkt er sich auf Printmedien?
  - Welche der 76 untersuchten Wortgruppen zeigen doch einen Rückgang, welche sind besonders stabil?
sources:
  - id: src1
    name: "derStandard: „Studie: Paradeiser, Rauchfangkehrer und Jänner verschwinden nicht“"
    type: media
    url: https://www.derstandard.at/story/3000000336487/studie-paradeiser-rauchfangkehrer-und-j228nner-verschwinden-nicht
  - id: src2
    name: "Kleine Zeitung: „Paradeiser, Rauchfangkehrer und Jänner sterben nicht aus“"
    type: media
    url: https://www.kleinezeitung.at/artikel/41190792/paradeiser-rauchfangkehrer-und-jaenner-sterben-nicht-aus
  - id: src3
    name: "Languages (MDPI): „Austriacisms and Their Co-Variants—Short-Term Diachrony in the 21st Century“"
    type: study
    url: https://doi.org/10.3390/languages11050102
claims:
  - id: claim1
    text: Ein Forschungsteam der ÖAW und der Universität Wien hat eine Studie zu Austriazismen in österreichischen Printmedien im Fachjournal „Languages“ veröffentlicht.
    status: supported
    sourceIds:
      - src1
      - src2
      - src3
  - id: claim2
    text: Der Untersuchungszeitraum der Studie umfasst rund 23 Jahre.
    status: supported
    sourceIds:
      - src1
      - src2
  - id: claim3
    text: Typisch österreichische Wörter wie „Paradeiser“, „Sackerl“ und „Jänner“ sind über den Untersuchungszeitraum in der Verwendung stabil geblieben und sterben nicht aus.
    status: supported
    sourceIds:
      - src1
      - src2
      - src3
  - id: claim4
    text: Die Studie untersucht 76 Wortgruppen mit rund 200 Varianten.
    status: partial
    note: Zahl stammt aus dem Publikationseintrag des Fachjournals, nicht aus einer vollständigen Lektüre des Studientexts; Angaben schwanken leicht zwischen rund 200 und 205 Varianten.
    sourceIds:
      - src3
  - id: claim5
    text: Als Autor:innen der Studie werden unter anderem Alexandra N. Lenz, Andreas Baumann, Wolfgang Koppensteiner, Claudia Mattes, Theresa Ziegler und Amelie Dorn genannt.
    status: partial
    note: Angabe basiert auf dem Publikationseintrag im Fachjournal, nicht auf einer vollständig eingesehenen Volltextquelle.
    sourceIds:
      - src3
corrections: []
---
